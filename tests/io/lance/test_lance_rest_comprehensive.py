...
from daft_lance.rest_write import (
...
class TestLanceRestWriteFunctions:
    ...
    def test_write_lance_rest_no_lance_namespace(self):
        ...
        with patch("daft_lance.rest_write.lance_namespace", None):
    ...
    @patch("daft_lance.rest_write.lance_namespace")
    ...
    def test_write_lance_rest_error_handling(self, mock_lance_namespace):
        ...
        with patch("daft_lance.rest_write.logger") as mock_logger:
